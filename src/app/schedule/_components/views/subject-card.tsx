...
export function SubjectCard({
  ...
  if (compact) {
    return (
      <Flex
        align="center"
        className={cn(
          'gap-1.5 rounded-md px-2 py-1 border-l-2 text-xs font-medium',
          colors.bg,
          colors.border,
          colors.text
        )}
  ...
  return (
    ...
    >
      ...
      <Flex wrap className="mt-3 gap-x-4 gap-y-1">
        <Flex align="center" className="gap-1 text-xs text-muted-foreground">
